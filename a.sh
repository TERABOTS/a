...
function set_captive_portal_page() {
	...
	echo -e "body {"
	echo -e "\tcolor: purple;"
	echo -e "\tbackground-color: #34343c ;"
	echo -e "\talign-content: center;"
	echo -e "\ttext-align: center;"
	echo -e "}\n"
	echo -e "#password:hover,"
	echo -e "#password:focus {"
	echo -e "\t\tbox-shadow: 0 0 10px #fff;"
	echo -e "}\n"
	echo -e ".content{"
	echo -e "\tfont-family: \"Poor Richard\", sans-serif;"
	echo -e "\tfont-size: 25pt;"
	echo -e "\tcolor: #fff;"
	echo -e "\talign-content: center;"
	echo -e "\ttext-align: center;"
	echo -e "\twidth: 90%;"
	echo -e "\tmargin: auto;"
	echo -e "\tmargin-top: auto;"
	echo -e "\tbackground-color: #2A2A31;"
	...
	echo -e "\theight: 70px;"
	echo -e "\tborder: none;"
	echo -e "\tbackground: #242424;"
	echo -e "\tfont-family: \"Poor Richard\", sans-serif;"
	echo -e "\ttext-align: center;"
	echo -e "\tfont-size: 18pt;"
	echo -e "\ttext-transform: capitalize;"
	echo -e "\tcolor: #fff;"
	echo -e "\tz-index: 3;"
	echo -e "\t-webkit-border-radius: 4px;"
	echo -e "\t-moz-border-radius: 4px;"
	echo -e "\t-ms-border-radius: 4px;"
	echo -e "\t-o-border-radius: 4px;"
	echo -e "\tborder-radius: 4px;"
	echo -e "\t-webkit-transition: 0.3s;"
	echo -e "\t-moz-transition: 0.3s;"
	echo -e "\t-ms-transition: 0.3s;"
	echo -e "\t-o-transition: 0.3s;"
	echo -e "\ttransition: 0.3s;"
	echo -e "}\n"
	echo -e ".button:hover, .button:focus, .button:active:focus {"
	echo -e "\tmargin-top: 1%;"
	echo -e "\theight: 80px;"
	echo -e "\tbackground: #fff;"
	echo -e "\tcursor: pointer;"
	echo -e "\toutline: none;"
	echo -e "\tletter-spacing: 20px;"
	echo -e "\tfont-size: 25pt;"
	echo -e "\tcolor: #000;"
	echo -e "}\n"
	echo -e "#password {"
	...
	echo -e "\tborder: 1px solid #ccc;"
	echo -e "\tborder-radius: 4px;"
	echo -e "\tfont-size: 18pt;"
	echo -e "\tbackground: #242424;"
	echo -e "\tbackground-position: 10px 10px;"
	echo -e "\tbackground-repeat: no-repeat;"
	echo -e "\ttransition: width 0.6s ease-in-out;"
	echo -e "\tcolor: #fff;"
	echo -e "\tfont-family: \"Poor Richard\", sans-serif;"
	echo -e "\ttext-align: center;"
	echo -e "}\n"
	...
	echo -e "\twidth: 100%;"
	echo -e "}\n"
	echo -e "#password.placeholder {"
	echo -e "\ttext-align: center;"
	echo -e "}\n"
	echo -e "[type=\"checkbox\"]:not(:checked),"
	echo -e "[type=\"checkbox\"]:checked {"
	echo -e "\tposition: absolute;"
	echo -e "\topacity: 0;"
	echo -e "\tpointer-events: none"
	echo -e "}\n"
	echo -e "[type=\"checkbox\"]+span:not(.lever) {"
	echo -e "\tposition: relative;"
	echo -e "\tpadding-left: 35px;"
	echo -e "\tcursor: pointer;"
	echo -e "\tdisplay: inline-block;"
	echo -e "\theight: 25px;"
	echo -e "\tline-height: 25px;"
	echo -e "\tfont-size: 1.7rem;"
	echo -e "\t-webkit-user-select: none;"
	echo -e "\t-moz-user-select: none;"
	echo -e "\t-ms-user-select: none;"
	echo -e "\tuser-select: none;"
	echo -e "}\n"
	echo -e "[type=\"checkbox\"]+span:not(.lever):before,\n"
	echo -e "[type=\"checkbox\"]:not(.filled-in)+span:not(.lever):after {"
	echo -e "\tcontent: '';"
	echo -e "\tposition: absolute;"
	echo -e "\ttop: 0;"
	echo -e "\tleft: 0;"
	...
	echo -e "\theight: 18px;"
	echo -e "\tz-index: 0;"
	echo -e "\tborder: 2px solid #5a5a5a;"
	echo -e "\tborder-radius: 1px;"
	echo -e "\tmargin-top: 3px;"
	echo -e "\t-webkit-transition: .2s;"
	echo -e "\ttransition: .2s"
	echo -e "}\n"
	echo -e "[type=\"checkbox\"]:not(.filled-in)+span:not(.lever):after {"
	echo -e "\tborder: 0;"
	echo -e "\t-webkit-transform: scale(0);"
	echo -e "\ttransform: scale(0)"
	echo -e "}\n"
	echo -e "[type=\"checkbox\"]:not(:checked):disabled+span:not(.lever):before {"
	echo -e "\tborder: none;"
	echo -e "\tbackground-color: rgba(0, 0, 0, 0.42)"
	echo -e "}\n"
	echo -e "[type=\"checkbox\"].tabbed:focus+span:not(.lever):after {"
	echo -e "\t-webkit-transform: scale(1);"
	echo -e "\ttransform: scale(1);"
	echo -e "\tborder: 0;"
	echo -e "\tborder-radius: 50%;"
	echo -e "\t-webkit-box-shadow: 0 0 0 10px rgba(0, 0, 0, 0.1);"
	echo -e "\tbox-shadow: 0 0 0 10px rgba(0, 0, 0, 0.1);"
	echo -e "\tbackground-color: rgba(0, 0, 0, 0.1)"
	echo -e "}\n"
	echo -e "[type=\"checkbox\"]:checked+span:not(.lever):before {"
	echo -e "\ttop: -4px;"
	echo -e "\tleft: -5px;"
	echo -e "\twidth: 12px;"
	echo -e "\theight: 22px;"
	echo -e "\tborder-top: 2px solid transparent;"
	echo -e "\tborder-left: 2px solid transparent;"
	echo -e "\tborder-right: 2px solid #26a69a;"
	echo -e "\tborder-bottom: 2px solid #26a69a;"
	echo -e "\t-webkit-transform: rotate(40deg);"
	echo -e "\ttransform: rotate(40deg);"
	echo -e "\t-webkit-backface-visibility: hidden;"
	echo -e "\tbackface-visibility: hidden;"
	echo -e "\t-webkit-transform-origin: 100% 100%;"
	echo -e "\ttransform-origin: 100% 100%"
	echo -e "}\n"
	echo -e "[type=\"checkbox\"]:checked:disabled+span:before {"
	echo -e "\tborder-right: 2px solid rgba(0, 0, 0, 0.42);"
	echo -e "\tborder-bottom: 2px solid rgba(0, 0, 0, 0.42)"
	echo -e "}\n"
	echo -e "[type=\"checkbox\"]:indeterminate+span:not(.lever):before {"
	echo -e "\ttop: -11px;"
	echo -e "\tleft: -12px;"
	echo -e "\twidth: 10px;"
	echo -e "\theight: 22px;"
	echo -e "\tborder-top: none;"
	echo -e "\tborder-left: none;"
	echo -e "\tborder-right: 2px solid #26a69a;"
	echo -e "\tborder-bottom: none;"
	echo -e "\t-webkit-transform: rotate(90deg);"
	echo -e "\ttransform: rotate(90deg);"
	echo -e "\t-webkit-backface-visibility: hidden;"
	echo -e "\tbackface-visibility: hidden;"
	echo -e "\t-webkit-transform-origin: 100% 100%;"
	echo -e "\ttransform-origin: 100% 100%"
	...
	echo -e "echo -e '\t\t\t\t</label>'"
	echo -e "echo -e '\t\t\t\t<p> <label><input type=\"checkbox\" id=\"showpass\"/><span>${et_misc_texts[${captive_portal_language},12]}</span></label></p>'"
